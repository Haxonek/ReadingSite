...
You should be able to perform full text searches using elasticsearch, create an account, follow people, comment with markdown, create chapters, add tags/description, modify you account/books, along with a few other features.
